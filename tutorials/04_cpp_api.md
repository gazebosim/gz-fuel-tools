...
```bash
# Ubuntu or MacOS
wget https://github.com/gazebosim/gz-fuel-tools/raw/gz-fuel-tools11/example/list.cc
wget https://github.com/gazebosim/gz-fuel-tools/raw/gz-fuel-tools11/example/details.cc
...
# Windows
## CMD
curl -sk https://github.com/gazebosim/gz-fuel-tools/raw/gz-fuel-tools11/example/list.cc -o list.cc
curl -sk https://github.com/gazebosim/gz-fuel-tools/raw/gz-fuel-tools11/example/details.cc -o details.cc
...
## PowerShell
curl https://github.com/gazebosim/gz-fuel-tools/raw/gz-fuel-tools11/example/list.cc -o list.cc
curl https://github.com/gazebosim/gz-fuel-tools/raw/gz-fuel-tools11/example/details.cc -o details.cc
