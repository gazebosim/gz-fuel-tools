...
class ignition::fuel_tools::CollectionIdentifier::Implementation
{
...
//////////////////////////////////////////////////
const ServerConfig &CollectionIdentifier::Server() const
{
  return this->dataPtr->server;
}

//////////////////////////////////////////////////
ServerConfig &CollectionIdentifier::Server()
{
  return this->dataPtr->server;
}
