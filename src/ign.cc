...
extern "C" IGNITION_FUEL_TOOLS_VISIBLE void listModels(const char *_url)
{
  ...
  {
    std::cout << "Fetching model list from " << server.URL() << "..." << std::endl;
    ...
    std::cout << "Received model list (took " << duration.count() << "ms)." << std::endl;
    ...
    std::cout << "\033[92m\033[1m" << server.URL() << "\033[39m\033[0m" << std::endl;
