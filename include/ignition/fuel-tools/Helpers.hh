...
/// Use to represent "symbol hidden" if supported
  ...
  #define IGNITION_FUEL_TOOLS_HIDDEN
    ...
    #ifdef BUILDING_DLL
      #ifdef __GNUC__
        #define IGNITION_FUEL_TOOLS_VISIBLE __attribute__ ((dllexport))
      #else
        #define IGNITION_FUEL_TOOLS_VISIBLE __declspec(dllexport)
      #endif
    #else
      #ifdef __GNUC__
        #define IGNITION_FUEL_TOOLS_VISIBLE __attribute__ ((dllimport))
      #else
        #define IGNITION_FUEL_TOOLS_VISIBLE __declspec(dllimport)
      #endif
    #endif
    #define IGNITION_FUEL_TOOLS_HIDDEN
  #else
      ...
      #define IGNITION_FUEL_TOOLS_HIDDEN  __attribute__ ((visibility ("hidden")))
    #else
      #define IGNITION_FUEL_TOOLS_VISIBLE
      #define IGNITION_FUEL_TOOLS_HIDDEN
    #endif
