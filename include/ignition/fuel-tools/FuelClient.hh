...
#include <ignition/fuel-tools/DeleteResult.hh>
#include <ignition/fuel-tools/ModelIter.hh>
#include <ignition/fuel-tools/UploadResult.hh>
...
namespace ignition
{
  namespace fuel_tools
  {
    ...
    class FuelClient
    {
      ...
      public: UploadResult UploadModel(const std::string &_pathToModelDir,
                  const ModelIdentifier &_id);

      /// \brief Remove a model from ignition fuel
      public: DeleteResult DeleteModel(const ModelIdentifier &_id);
