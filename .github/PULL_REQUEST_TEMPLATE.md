...
Branch comparison: https://github.com/ignitionrobotics/ign-fuel-tools/compare/<TO_BRANCH>...<FROM_BRANCH>
...
Comparison to <x.y.z>: https://github.com/ignitionrobotics/ign-fuel-tools/compare/<LATEST_TAG_BRANCH>...<RELEASE_BRANCH>
